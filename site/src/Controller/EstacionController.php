	...
	public function checkin()
	{
		...
		if ($user->authorise('core.manage', 'com_mantenimiento') || $item->checked_out == $user->id) { 
			...
			if ($return === false)
			{
				...
				$this->setRedirect(Route::_('index.php?option=com_mantenimiento&view=estacion' . '&id=' . $id, false), $message, 'error');
				return false;
			}
			else
			{
				...
				$this->setRedirect(Route::_('index.php?option=com_mantenimiento&view=estacion' . '&id=' . $id, false), $message);
				return true;
			}
		}
		else
