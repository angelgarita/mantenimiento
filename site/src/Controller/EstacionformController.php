...
class EstacionformController extends FormController
{
	...
	public function edit($key = NULL, $urlVar = NULL)
	{
		...
		$previousId = (int) $this->app->getUserState('com_mantenimiento.edit.estacion.id');
		$editId     = $this->input->getInt('id', 0);

		// Set the user id for the user to edit in the session.
		$this->app->setUserState('com_mantenimiento.edit.estacion.id', $editId);
	...
	public function save($key = NULL, $urlVar = NULL)
	{
		...
		if ($data === false)
		{
			...
			$this->app->setUserState('com_mantenimiento.edit.estacion.data', $jform);

			// Redirect back to the edit screen.
			$id = (int) $this->app->getUserState('com_mantenimiento.edit.estacion.id');
		...
		{
			// Save the data in the session.
			$this->app->setUserState('com_mantenimiento.edit.estacion.data', $data);
		...
		$this->app->setUserState('com_mantenimiento.edit.estacion.id', null);
	...
	public function cancel($key = NULL)
	{
		...
		$editId = (int) $this->app->getUserState('com_mantenimiento.edit.estacion.id');
