...
/**
 * Methods supporting a list of Mantenimiento records.
 *
 * @since  1.0.0
 */
	...
	protected function getListQuery()
	{
			...
			if (!empty($search))
			{
				...
				else
				{
					...
					$query->where('( a.nombre LIKE ' . $search . '  OR  a.ind_sinoptico LIKE ' . $search . '  OR  a.ind_climatologico LIKE ' . $search . '  OR  a.tipo_estacion LIKE ' . $search . '  OR  a.variables LIKE ' . $search . ' )');
				}
			}
